...
func (_q *ActivityLogQuery) QueryWorkspace() *WorkspaceQuery {
...
func (_q *ActivityLogQuery) QueryTask() *TaskQuery {
...
func (_q *ActivityLogQuery) WithWorkspace(opts ...func(*WorkspaceQuery)) *ActivityLogQuery {
	query := (&WorkspaceClient{config: _q.config}).Query()
...
func (_q *ActivityLogQuery) WithTask(opts ...func(*TaskQuery)) *ActivityLogQuery {
	query := (&TaskClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ActivityLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ActivityLog, error) {
	...
	if query := _q.withWorkspace; query != nil {
		if err := _q.loadWorkspace(ctx, query, nodes, nil,
			func(n *ActivityLog, e *Workspace) { n.Edges.Workspace = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTask; query != nil {
		if err := _q.loadTask(ctx, query, nodes, nil,
			func(n *ActivityLog, e *Task) { n.Edges.Task = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ActivityLogQuery) loadWorkspace(ctx context.Context, query *WorkspaceQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *Workspace)) error {
...
func (_q *ActivityLogQuery) loadTask(ctx context.Context, query *TaskQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *Task)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*ActivityLog)
	for i := range nodes {
...
func (_q *ActivityLogQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withWorkspace != nil {
			_spec.Node.AddColumnOnce(activitylog.FieldWorkspaceID)
		}
		if _q.withTask != nil {
			_spec.Node.AddColumnOnce(activitylog.FieldTaskID)
		}
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(activitylog.FieldProjectID)
		}
		if _q.withActor != nil {
			_spec.Node.AddColumnOnce(activitylog.FieldActorID)
		}
	}
