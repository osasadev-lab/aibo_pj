...
func (_c *TagCreate) SetWorkspaceID(v uuid.UUID) *TagCreate {
...
func (_c *TagCreate) AddTaskIDs(ids ...uuid.UUID) *TagCreate {
	_c.mutation.AddTaskIDs(ids...)
	return _c
}

// AddTasks adds the "tasks" edges to the TaskTag entity.
func (_c *TagCreate) AddTasks(v ...*TaskTag) *TagCreate {
