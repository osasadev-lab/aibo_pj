...
// HasStatusColumns applies the HasEdge predicate on the "status_columns" edge.
func HasStatusColumns() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasStatusColumnsWith applies the HasEdge predicate on the "status_columns" edge with a given conditions (other predicates).
func HasStatusColumnsWith(preds ...predicate.ProjectStatusColumn) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newStatusColumnsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasSections() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSectionsWith(preds ...predicate.Section) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
