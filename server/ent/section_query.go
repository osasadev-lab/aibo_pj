...
func (_q *SectionQuery) QueryProject() *ProjectQuery {
...
func (_q *SectionQuery) QueryTasks() *TaskQuery {
...
func (_q *SectionQuery) WithProject(opts ...func(*ProjectQuery)) *SectionQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
func (_q *SectionQuery) WithTasks(opts ...func(*TaskQuery)) *SectionQuery {
	query := (&TaskClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SectionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Section, error) {
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *Section, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTasks; query != nil {
		if err := _q.loadTasks(ctx, query, nodes,
			func(n *Section) { n.Edges.Tasks = []*Task{} },
			func(n *Section, e *Task) { n.Edges.Tasks = append(n.Edges.Tasks, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SectionQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Section, init func(*Section), assign func(*Section, *Project)) error {
...
func (_q *SectionQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*Section, init func(*Section), assign func(*Section, *Task)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(task.FieldSectionID)
	}
	query.Where(predicate.Task(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(section.TasksColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *SectionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(section.FieldProjectID)
		}
	}
